...
class ZpkInvokablePackTest extends ZpkTestCase
{
    ...
    public function testProjectPack()
    {
        ...
        $expected   = array(
            ...
            'data/module/Client/views/1aaa.phtml',
            'data/module/Client/views/2aaa.phtml',
            'data/module/Client/views/3aaa.phtml',
    ...
    public function testLibraryPack()
    {
        ...
        $expected   = array(
            ...
            'module/Client/views/1aaa.phtml',
            'module/Client/views/2aaa.phtml',
            'module/Client/views/3aaa.phtml',
            'public/index.php',
            'public/x.flav',
            'scriptsdir/zend/scripts/pre_activate.php',
            'scriptsdir/zend/scripts/post_stage.php',
